...
func main() {
	var (
		...
		dsn    = flag.String("DSN", "catalogue_user:default_password@tcp(awsb-cataloguedb.cxmtjrbucdp3.ap-northeast-2.rds.amazonaws.com:3306)/socksdb", "Data Source Name: [username[:password]@][protocol[(address)]]/dbname")
